...
def create_coord_dict(page_path):
    ...
    table_dict_cpy2 = table_dict.copy()

    for table_key in table_dict_cpy2:
        table = table_dict_cpy2[table_key]['cell']
        ...
        table_dict[table_key]['page_no'] = int(page_no)
